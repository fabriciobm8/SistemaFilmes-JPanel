...
public class FilmeTableModel extends AbstractTableModel {
    ...
    private final String[] colunas = {
            "ID", "Descrição", "Diretor", "Gênero", "Tipo", "Origem", 
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        return switch (columnIndex) {
            ...
            case 2 -> filme.getDiretor();
            case 3 -> filme.getGenero() != null ? filme.getGenero().getDescricao() : "";
            case 4 -> filme.getTipo() != null ? filme.getTipo().getDescricao() : "";
            case 5 -> filme.getOrigem() != null ? filme.getOrigem().getDescricao() : "";
            case 6 -> filme.getTipoMidia() != null ? filme.getTipoMidia().getDescricao() : "";
            case 7 -> filme.getLocacao() != null ? filme.getLocacao().getDescricao() : "";
            case 8 -> filme.getSublocacao() != null ? filme.getSublocacao().getDescricao() : "";
            case 9 -> filme.getEstante();
            case 10 -> filme.getEstantePrateleira();
            case 11 -> filme.getEstantePrateleiraColuna();
            default -> null;
        };
    }

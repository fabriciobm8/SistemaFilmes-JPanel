...
public class FilmeController {
    ...
    public List<Filme> buscarPorFiltro(String descricao, Integer anoInicial, Integer anoFinal, String diretor,
        ...
        if (anoInicial != null) {
            filtros.put("anoInicial", anoInicial);
        }

        if (anoFinal != null) {
            filtros.put("anoFinal", anoFinal);
        }

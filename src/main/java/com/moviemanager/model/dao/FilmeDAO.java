...
public class FilmeDAO {
    ...
    public Filme save(Filme filme) throws SQLException {
        ...
        if (filme.getId() == null) {
            // Insert
            sql = "INSERT INTO filmes (descricao, ano, diretor, genero, tipo, origem, tipo_midia, " +
            ...
            try (Connection conn = DatabaseConnection.getConnection();
                ...
                stmt.setObject(i++, filme.getAno(), Types.INTEGER);
            ...
            // Update
            sql = "UPDATE filmes SET descricao = ?, ano = ?, diretor = ?, genero = ?, tipo = ?, " +
    ...
    public List<Filme> findByFilter(Map<String, Object> filters) throws SQLException {
        ...
        if (filters.containsKey("anoInicial") && filters.get("anoInicial") != null) {
            sql.append(" AND ano >= ?");
            params.add(filters.get("anoInicial"));
        }

        if (filters.containsKey("anoFinal") && filters.get("anoFinal") != null) {
            sql.append(" AND ano <= ?");
            params.add(filters.get("anoFinal"));
        }
    ...
    private Filme mapResultSetToFilme(ResultSet rs) throws SQLException {
        ...
        filme.setAno(rs.getObject("ano") != null ? rs.getInt("ano") : null);
